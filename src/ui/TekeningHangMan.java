...
public class TekeningHangMan extends Tekening {
	...
	public TekeningHangMan() {
		...
		Vorm galgStaaf = new LijnStuk(new Punt(160, 50),new Punt(160, 350));
		...
		Vorm beenLinks = new LijnStuk(new Punt(240, 250),new Punt(280, 310) );
		...
		Vorm armLinks = new LijnStuk( new Punt(230, 170),new Punt(280, 200));
